      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade-up">
            <span class="custom-caption text-uppercase text-white d-block  mb-3">hallo sobat futsal <span class="fa fa-star text-primary"></span>  MADEP</span>
            <h1 class="heading">welcome to GFI web</h1>
          </div>
        </div>
      </div>
            ...
            <form action="#">
              <div class="row">
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  <label for="booking disini bos!" class="font-weight-bold text-black">booking disini bos!</label>
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input type="text" id="booking disini bos!" class="form-control">
                  </div>
                </div>
                <div class="col-md-6 mb-3 mb-lg-0 col-lg-3">
                  <label for="hari & tanggal" class="font-weight-bold text-black">hari & tanggal</label>
                  <div class="field-icon-wrap">
                    <div class="icon"><span class="icon-calendar"></span></div>
                    <input type="text" id="hari & tanggal" class="form-control">
                  </div>
                </div>
                <div class="col-md-6 mb-3 mb-md-0 col-lg-3">
                  <div class="row">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <label for="have fun" class="font-weight-bold text-black">have fun</label>
                      <div class="field-icon-wrap">
                        <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                        <select name="" id="have fun" class="form-control">
                    ...
                    <div class="col-md-6 mb-3 mb-md-0">
                      <label for="tournament" class="font-weight-bold text-black">tournament</label>
                      <div class="field-icon-wrap">
                        <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                        <select name="" id="tournament" class="form-control">
                          <option value="">2-4 jam</option>
                          <option value="">4-6 jam</option>
                          <option value="">6-8 jam</option>
                          <option value="">8-10 jam</option>
                          <option value="">10-12 jam</option>
                        </select>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-4 order-lg-1" data-aos="fade-up">
            <h2 class="heading">Welcome To GFI!</h2>
            <p class="mb-4">Selamat Datang di Website GFI Futsal Center!

Kami dengan bangga mempersembahkan platform resmi kami untuk semua penggemar futsal! Di sini, Anda akan menemukan segala informasi yang Anda butuhkan tentang fasilitas, jadwal pertandingan, dan acara-acara seru di GFI Futsal Center.</p>
