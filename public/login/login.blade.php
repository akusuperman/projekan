...
<form action="/user/autenticate" method="POST" enctype="multipart/form-data">
    @csrf
...
<form action="/user/admin" method="POST" enctype="multipart/form-data">
    @csrf
<input type="text" placeholder="Name" autocomplete="off"><br>
<input type="No Telp" placeholder="No Telp" autocomplete="off"><br>
<input type="Alamat" placeholder="Alamat" autocomplete="off"><br>
<input type="email" placeholder="Email" autocomplete="off"><br>
<input type="password" placeholder="Password" autocomplete="off"><br>
